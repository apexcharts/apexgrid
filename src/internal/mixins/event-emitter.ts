...
//     options?: boolean | AddEventListenerOptions,
//   ): void;
//   public removeEventListener<K extends keyof M, M extends E & HTMLElementEventMap>(
//     type: K,
//     listener: (this: HTMLElement, ev: M[K]) => any,
...
// export function EventEmitterMixin<E, T extends Constructor<LitElement>>(superClass: T) {
