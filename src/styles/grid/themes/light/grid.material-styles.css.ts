...
export const styles = css`
  ...
  :host {
    ...
    --header-text-color: hsl(from var(--ig-gray-800) h s l/0.7);
    --header-border-width: 0.0625rem;
    --header-border-style: solid;
    --header-border-color: hsl(from var(--ig-gray-400) h s l/0.38);
    ...
    --sorted-header-icon-color: var(--ig-secondary-500);
    --icon-color: "currentColor";
    --row-hover-background: var(--ig-gray-200);
    --row-hover-text-color: var(--ig-gray-200-contrast);
    --row-even-background: var(--ig-gray-50);
    --row-even-text-color: var(--ig-gray-800);
    --row-odd-background: var(--ig-gray-50);
    --row-odd-text-color: var(--ig-gray-800);
    --row-border-color: hsl(from var(--ig-gray-300) h s l/0.38);
    --row-border-style: var(--header-border-style);
    --row-border-width: var(--header-border-width);
    --cell-active-border-color: var(--ig-secondary-500);
    --grid-resize-line-color: var(--ig-secondary-500);
  }
